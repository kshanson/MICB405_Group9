...
write.table(top50_genes, file = "top50_genes_45.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
```
```{r}
...
write.table(bot50_genes, file = "bot50_genes_45.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
## Save file as csv
```{r}
write_csv(res_filtered_final, "yeast_results_45.csv")
```
